...
import { getFirestore, collection, addDoc, query, orderBy, onSnapshot, where, getDocs, doc, updateDoc, serverTimestamp } from "https://www.gstatic.com/firebasejs/12.11.0/firebase-firestore.js";
...
onAuthStateChanged(auth, (user) => {
  ...
  if (user && user.emailVerified) {
    ...
    if(document.getElementById("items")) loadItems();
